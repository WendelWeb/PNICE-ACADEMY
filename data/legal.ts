 ...
 * card payments in USD via Stripe with an indicative HTG display price,
 * three products (course à l'unité, per-teacher "Pass Prof" subscription,
 * all-access "Pass PNICE" subscription), completion certificates, videos
 * streamed via a CDN, Google sign-in, and support via tickets.
 *
...
export const LEGAL_DEFAULTS_UPDATED_AT = '2026-08-03T00:00:00.000Z';
...
4. Pri ak peman
Tout peman fèt an dola ameriken (USD), ak kat bankè, atravè patnè peman nou an, Stripe. Nou pa janm wè ni kenbe nimewo kat ou. Pri an goud (HTG) ki parèt sou sit la se yon endikasyon sèlman, dapre yon to referans nou mete ajou; se montan USD la ki debite.
...
11. Sipò
Pou nenpòt kesyon oswa pwoblèm, louvri yon tikè sipò nan kont ou (Kont → Sipò) oswa ekri nou: kontak@pnice.academy. Nou reponn pi vit posib, an kreyòl oswa an franse.
...
13. Kontak
PNICE Academy — kontak@pnice.academy`;
...
4. Prix et paiement
Tous les paiements se font en dollars américains (USD), par carte bancaire, via notre partenaire de paiement Stripe. Nous ne voyons ni ne conservons jamais ton numéro de carte. Les prix affichés en gourdes (HTG) sont donnés à titre indicatif, selon un taux de référence mis à jour par nos soins ; c'est le montant en USD qui est débité.
...
11. Support
Pour toute question ou tout problème, ouvre un ticket de support depuis ton compte (Compte → Support) ou écris-nous : kontak@pnice.academy. Nous répondons au plus vite, en créole ou en français.
...
• Acha ou yo: ki kou oswa abònman ou peye, dat ak montan yo. Se Stripe ki trete kat ou; nou pa janm wè ni kenbe nimewo kat ou.
...
• Stripe — peman ak kat; se yo ki kenbe enfòmasyon kat ou, dapre estanda sekirite bankè yo.
...
Nou kenbe done kont ou toutotan kont lan aktif. Resi ak dosye peman yo rete pi lontan paske lalwa ak kontabilite mande sa. Si w fèmen kont ou, nou efase oswa rann anonim done ki pa nesesè ankò.

7. Dwa ou yo
Ou gen dwa: wè done nou gen sou ou, korije yo, oswa mande efase kont ou. Pou sa, louvri yon tikè sipò oswa ekri kontak@pnice.academy. N ap reponn ou pi vit posib.
...
10. Kontak
Pou nenpòt kesyon sou done ou: kontak@pnice.academy`;
...
• Tes achats : les cours ou abonnements payés, avec date et montant. C'est Stripe qui traite ta carte ; nous ne voyons ni ne conservons jamais ton numéro de carte.
...
• Stripe — paiement par carte ; c'est lui qui conserve les informations de ta carte, selon les standards de sécurité bancaires.
...
Nous conservons les données de ton compte tant qu'il est actif. Les reçus et pièces de paiement sont conservés plus longtemps, pour des raisons légales et comptables. Si tu fermes ton compte, nous supprimons ou anonymisons les données devenues inutiles.

7. Tes droits
Tu as le droit de : consulter les données que nous détenons sur toi, les corriger, ou demander la suppression de ton compte. Pour cela, ouvre un ticket de support ou écris à kontak@pnice.academy. Nous te répondrons au plus vite.
...
10. Contact
Pour toute question sur tes données : kontak@pnice.academy`;
...
Louvri yon tikè sipò nan kont ou (Kont → Sipò) oswa ekri kontak@pnice.academy, ak imèl kont ou ak non kou a. Ou pa bezwen esplike anpil — men si w di nou sa k pa mache, sa ede nou amelyore.

5. Kijan nou remèt lajan an
Ranbousman an fèt atravè Stripe, sou menm kat ou te peye a, an USD. Apre nou apwouve l, bank ou ka pran 5 a 10 jou ouvrab pou montre lajan an sou kont ou. Nou pa ka voye ranbousman sou yon lòt kat oswa yon lòt kont.
...
7. Kontak
Kesyon sou yon peman? kontak@pnice.academy — oswa yon tikè sipò nan kont ou.`;
...
Ouvre un ticket de support depuis ton compte (Compte → Support) ou écris à kontak@pnice.academy, en indiquant l'e-mail de ton compte et le nom du cours. Pas besoin de longues justifications — mais nous dire ce qui n'a pas convenu nous aide à nous améliorer.

5. Comment nous te remboursons
Le remboursement passe par Stripe, sur la carte utilisée pour le paiement, en USD. Une fois la demande approuvée, ta banque peut mettre 5 à 10 jours ouvrés à afficher le montant sur ton compte. Nous ne pouvons pas rembourser vers une autre carte ou un autre compte.
...
7. Contact
Une question sur un paiement ? kontak@pnice.academy — ou un ticket de support depuis ton compte.`;
